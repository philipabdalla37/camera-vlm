...
MOVEMENT_THRESHOLD = 3.7      # Adjust if needed
STILLNESS_REQUIRED = 10       # Frames of stillness before capture
ANGLE_TOLERANCE = 5        # Degrees of tolerance for orientation check
...
SKILLS = ["strength", "intelligence", "charisma", "dexterity"]

SECTIONS = [[0, "strength", (16, 188, 150, 235)],
    [0, "intelligence", (16, 245, 150, 290)],
    [0, "charisma", (16, 300, 150, 350)],
    [0, "dexterity", (16, 360, 150, 410)],
    [1, "name", (175, 70, 570, 131)],
    [1 , "Description", (140, 190, 590, 535)]]
